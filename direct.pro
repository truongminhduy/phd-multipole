...
Formulation {
  ...
  //     // Galerkin { [-source[]               , {u}   ]; In src; Jacobian JVol; Integration Int_1;  }
  //     Galerkin { [-source[]               , {u}   ]; In Omega; Jacobian JVol; Integration Int_1;  }
  //   }
  // }
}
...
PostOperation {
  { Name postop_scat; NameOfPostProcessing get_scat ;
    Operation {
      ...
      Print[ unorm, OnPoint {0,0,0}, Format TimeTable, File "E0_01.txt"];
      Print[ unorm, OnPoint {xD1,yD1,0}, Format TimeTable, File "E0_11.txt"];
      Print[ unorm, OnPoint {xD2,yD2,0}, Format TimeTable, File "E0_21.txt"];
    }
  }
}
///////////////////////////////////////////////////////////// END //////////////
