...
PostProcessing {
  { Name postpro_modal; NameOfFormulation Ez;
    Quantity {            
      { Name uss; Value { Local { [ Field[XYZ[]]{0} + Field[XYZ[]]{1} + Field[XYZ[]]{2} + Field[XYZ[]]{3} + Field[XYZ[]]{4} + Field[XYZ[]]{5}] ; In Omega_plot; Jacobian JVol; } } }  
      { Name E2 ; Value { Integral { [ Norm[ Field[XYZ[]]{0} + Field[XYZ[]]{1} + Field[XYZ[]]{2} + Field[XYZ[]]{3}] + Field[XYZ[]]{4} + Field[XYZ[]]{5}] ; In Omega_in; Integration Int_1 ; Jacobian JVol ; } } }     
    }
  }
}
