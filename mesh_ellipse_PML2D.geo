...
lc_mil  = lambda_m*5e-2;
lc_pml  = lambda_m*15e-2;
...
// // triangle
// Point(1)  = {xA,yA,0.,  lc_diff };
// Point(2)  = {xB,yB,0.,  lc_diff };
// Point(3)  = {xC,yC,0.,  lc_diff };
...
Mesh.CharacteristicLengthMax = lc_mil;
// Characteristic Length{ PointsOf{ Surface{:}; } } = lc_pml;
Characteristic Length{ PointsOf{ Surface{9}; } } = lc_mil;
Characteristic Length{ PointsOf{ Surface{10}; } } = lc_diff;
Characteristic Length{ PointsOf{ Surface{11}; } } = lc_diff*4e-1;
